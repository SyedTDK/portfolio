            ...
            <body className="bg-back bg-cover backdrop-blur-sm min-h-screen">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 backdrop-blur-md">
                    ...
                    <div className="justify-center">
                        <p className="font-bold">Well Being: Created a dynamic and interactive web application using Next.js, a React framework. This project focused on engaging users through personalized daily prompts, allowing them to sign up, log in, submit responses, and revisit their entries.
