    ...
    return (
        ...
        <body className='bg-back bg-cover backdrop-blur-sm min-h-screen overscroll-none'>
            ...
            <div className='flex justify-center p-5'>
                ...
                Currently, I'm a Software Engineer at <a href="https://steminstitutenyc.org/" target='_blank'><img src='/SI.svg' height="100" width="100" className='inline'></img></a>. I am proficient in various programming 
