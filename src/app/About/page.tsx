    ...
    return (
        ...
        <body className='bg-back bg-cover backdrop-blur-sm min-h-screen'>
            ...
            <div className='flex justify-center p-5'>
                <p className='text-2xl font-bold backdrop-blur-md'>Hey, I’m Syed and I am an aspiring Frontend developer pursuing a Bachelor of Engineering in Computer Engineering from The City College of New York. 
