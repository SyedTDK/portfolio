    ...
    return (
        ...
        <body className='bg-back bg-cover'>
            ...
            <div className='flex justify-center p-5'>
                <p className='text-2xl font-bold backdrop-blur-md'>Hey, I’m Syed and I am an aspiring full-stack developer pursuing a Bachelor of Engineering in Computer Engineering from The City College of New York. 
            ...
            <div className='flex justify-center'>
                <a href='/Resume - Syed Faizullah.pdf' target="_blank" className='text-3xl font-bold hover:underline'>Resume</a>
            </div>
        </body>
        </>
    )
