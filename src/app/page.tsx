      ...
      <Header />
        <main className='flex items-center justify-center px-4 mx-auto max-w-screen-xl min-h-screen text-center lg:px-12'>
          <div className='w-full text-2xl text-left'>
            ...
            Hello <span className='wave'>&#128075;</span> I’m Syed Faizullah. I work as a <span className='font-bold'>Data Analyst</span> at the <a className='text-yellow-500 hover:text-yellow-700' href="https://steminstitutenyc.org/" target='_blank'>Stem Institute</a>, an academic enrichment organization. Previously, I worked as a <span className='font-bold'>Data Analyst</span> at <a className=' text-blue-500 hover:text-blue-700' href='https://stem-sc.com/'>CUNY RF</a>. I enjoy working with technology and analyzing and solving complex problems. 
